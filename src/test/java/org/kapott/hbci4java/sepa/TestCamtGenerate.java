    ...
    public void test001() throws Exception
    {
        ...
        for (int i=0;i<list1.size();++i)
        {
            ...
            for (int k=0;k<tag1.lines.size();++k)
            {
                ...
                Assert.assertEquals("isCamt falsch",line1.camt,line2.camt);
                Assert.assertEquals("isSepa falsch",line1.sepa,line2.sepa);
                Assert.assertEquals("isStorno falsch",line1.storno,line2.storno);
