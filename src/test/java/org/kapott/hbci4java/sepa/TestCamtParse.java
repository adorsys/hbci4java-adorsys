    ...
    public void test004() throws Exception {
        ...
        try {
...

            {
                ...
                Assert.assertTrue("Buchung nicht als CAMT-Buchung markiert", l.camt);
                Assert.assertTrue("Buchung nicht als SEPA-Buchung markiert", l.sepa);
                Assert.assertFalse("Buchung ist kein Storno", l.storno);
