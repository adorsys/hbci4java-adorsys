...
public class PainVersion implements Comparable<PainVersion> {
    ...
    public static PainVersion choose(String sepadesc, String sepadata) {
        ...
        try {
            ...
            log.debug("pain version given in sepadescr: " + versionDesc);
            log.debug("pain version according to data: " + versionData);
            ...
            if (!versionDesc.equals(versionData))
                log.warn("pain version mismatch. sepadesc: " + versionDesc + " vs. data: " + versionData);
