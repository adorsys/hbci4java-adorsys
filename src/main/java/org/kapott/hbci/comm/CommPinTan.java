...
public final class CommPinTan extends Comm {
    ...
    public CommPinTan(HBCIPassportInternal parentPassport) {
        ...
        try {
            HBCIUtils.log("connect: " + parentPassport.getHost(), HBCIUtils.LOG_INFO);
    ...
    protected void ping(MSG msg) {
        try {
            byte[] b = getPassport().getCommFilter().encode(msg.toString(0));
            ...
            boolean checkCert = ((AbstractPinTanPassport) getPassport()).getCheckCert();
