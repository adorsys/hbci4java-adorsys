 ...
 */
public class GenLastSEPA00800202 extends AbstractSEPAGenerator<Map<String, String>> {
    /**
    ...
    public void generate(Map<String, String> sepaParams, OutputStream os, boolean validate) {
        ...
        try {
            ...
            throw new HBCI_Exception("Lastschrift-Art " + type + " wird in der SEPA-Version 008.002.02 Ihrer Bank " +
