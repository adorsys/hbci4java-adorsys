...
public class QRCode {
     ...
     *            maschinenlesbaren Daten direkt in der Text-Nachricht per Base64-Codierung in den Tags CHLGUC und
     *            CHLGTEXT.
     *            Wir brauchen daher auch den eigentlich dem User anzuzeigenden Text, um den Code bei Bedarf dort zu
     *            extrahieren.
    ...
    public QRCode(String hhd, String msg) throws Exception {
        byte[] data = hhd != null && hhd.length() > 0 ? hhd.getBytes(CommPinTan.ENCODING) : null;
